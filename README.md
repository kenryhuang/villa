...
scenes/
  farm3d/
    ...
    buildings/                  原生 3D 建筑：谷仓、风车、食品工坊、蜂箱、鸡舍
...
scripts/
  farm3d/
    ...
    farm_golf.gd                鼠标挥杆、站位、跟球、七洞流程与操作条
    ...
    golf_round.gd               七洞杆数、球位检查点与个人最佳存档
...
**鸡舍**：从“建筑”菜单放置 3×3 鸡舍，耗木板×8、石砖×4、绳索×1。完工后从南面点击鸡舍添饲料；每天 1 份动物饲料产 2 枚鸡蛋，蛋篮最多存 6 枚。点击蛋篮或面板收进背包，供市场交易或食品工坊使用。两只母鸡会走动、啄食；缺料、存满或维护时停产。面板打开时暂停时间，Esc 恢复。[模型、规则与重建说明](assets/models/buildings/chicken_coop/README.md)。
...
**高尔夫（七洞鼠标挥杆）**：从市集路牌沿路到球杆架（西 109 / 南 62 米），点击或 **E** 借杆，球旁 **E** 站位。**A/D** 瞄准、**Shift+A/D** 精调；**W/S 或滚轮** 调整上下触球点，**Z/C** 调整左曲／右曲，**X** 侧旋归零，**H** 切换左右手，**Q/E** 调整站距。左键后拉定力度、前推击球，松开取消；**右键拖动** 转镜头，**1/2/3** 换杆，**−/=** 调灵敏度。北侧已扩展为七洞弯曲球道，含树冠遮挡、水塘、沙坑和侧坡，共 28 标准杆。贴地过洞即进，飞过水塘合法、落水罚杆。球场内 **R** 从 1 洞重开，**Esc** 退出站位／跟球。旧三洞存档只重置高尔夫轮次与旧场地最佳成绩，农庄资产保留。玩法和验证见[高尔夫说明](docs/validation/golf-3d.md)。
