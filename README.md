...
**高尔夫（C：鼠标挥杆）**：从市集旁“湖西高尔夫”路牌沿小路到球杆架（西 124 / 南 62 米），点击或按 **E** 免费开始。走到球旁按 **E** 站位，角色右手主握杆、向左挥击。**A/D** 瞄准，**Q/E** 调整站距，**W/S 或滚轮** 上下调整触球点；球下部配合大力度可以挑高，中心轻击可以推球。**按住左键向后拉鼠标，再向前推过击球点**；后拉幅度与前推速度影响力度，横向偏移影响出球方向。**右键拖动** 可在准备、挥杆和跟球时转动镜头。**1/2/3** 选择开球杆、挖起杆、推杆，**− / =** 调整本次游戏的挥杆灵敏度。球停后走过去继续，进洞后前往下一发球台按 E。三洞计分并保存个人最佳，Esc 退出站位／跟球。实景与验证见[高尔夫说明](docs/validation/golf-3d.md)。
