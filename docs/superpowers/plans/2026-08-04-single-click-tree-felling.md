...
- [x] **Step 2: Run `godot --path . --headless -s res://tests/run_tests.gd`**

Expected: FAIL because `is_variant_choppable()` is absent and old generation uses list origin.

- [x] **Step 3: Implement the whitelist**
...
- [x] **Step 1: Write failing asset-manifest tests**
...
- [x] **Step 3: Generate one atlas from each exact source tree**
...
- [x] **Step 4: Add the atlas manifest and configure dependency**
...
- [x] **Step 1: Write failing frame-boundary tests**
...
- [x] **Step 2: Run gathering visual tests and verify RED**

Expected: missing felling API and old cylinder stump failures.

- [x] **Step 3: Implement atlas slicing and presentation state**
...
- [x] **Step 4: Rerun visual tests and verify GREEN**
...
- [x] **Step 1: Write failing fresh/partial/full-inventory tests**
...
- [x] **Step 2: Run resource and main-gameplay tests and verify RED**

Expected: transaction currently hardcodes quantity 1.

- [x] **Step 3: Override the tree reward contract**
...
- [x] **Step 4: Generalize `ToolSystem` to preview quantity**
...
- [x] **Step 5: Rerun tests and verify GREEN**
...
- [x] **Step 1: Write failing duration/cancel/anchor tests**
...
- [x] **Step 2: Run main-gameplay and visual tests and verify RED**

- [x] **Step 3: Implement target duration and felling callbacks**
...
- [x] **Step 4: Implement the root anchor**
...
- [x] **Step 1: Write failing hover lifecycle tests**
...
- [x] **Step 2: Run pointer/visual tests and verify RED**

Expected: decorative tree interaction areas are disabled and no hover signal/ring exists.

- [x] **Step 3: Expose standing-tree hover collision**
...
- [x] **Step 4: Emit and clear hover state**
...
- [x] **Step 5: Render a separate hover ring**
...
- [x] **Step 6: Rerun pointer/visual/main tests and verify GREEN**
...
- [x] **Step 2: Run resource/economy tests and verify RED**

- [x] **Step 3: Add explicit retirement handling**
...
- [x] **Step 4: Rerun migration/economy tests and verify GREEN**
...
- [x] **Step 1: Replace repeated-tree integration assertions**
...
- [x] **Step 2: Add cancellation coverage**
...
- [x] **Step 3: Extend deterministic captures**
...
- [x] **Step 4: Run and inspect Windows captures**
...
- [x] **Step 5: Run every automated runner**
...
- [x] **Step 6: Update formal docs and static-check**
...
- [x] **Step 7: Request final code/art review**
...
- [x] **Step 8: Commit final validation**
...
- [x] Exactly five approved variants are choppable everywhere; all other trees show red hover and reject clicks without movement/cost.
- [x] One fresh tree action lasts 2 seconds, atomically awards 5 wood, deducts 8 stamina/1 durability, advances 10 minutes, and ends as a painted stump.
- [x] Five matched atlases each contain three felling frames plus a stump with stable transparent root anchors.
- [x] Axe impact sits at the low trunk; ore/pickaxe behavior stays unchanged.
- [x] Cancellation at every felling phase restores the tree without gameplay/event mutation.
- [x] Old partial/retired tree saves load safely and newly eligible stable trees backfill full.
- [x] All tests, captures, static checks, and final review pass.
