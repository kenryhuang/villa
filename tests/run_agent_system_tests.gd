...
const AgentRolesTest = preload("res://tests/test_agent_roles.gd")
const AgentInteractionsTest = preload("res://tests/test_agent_interactions.gd")
const AgentAgreementsTest = preload("res://tests/test_agent_agreements.gd")
...
const AgentMarketSummaryTest = preload("res://tests/test_agent_market_summary.gd")
...
func _run() -> void:
	...
	AgentRolesTest.new().run(assertions)
	AgentInteractionsTest.new().run(assertions)
	AgentAgreementsTest.new().run(assertions)
	...
	AgentMarketSummaryTest.new().run(assertions)
