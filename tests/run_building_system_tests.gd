...
const BuildingOutputPileTest = preload("res://tests/test_building_output_pile.gd")
const BuildingOutputDisplayTest = preload("res://tests/test_building_output_display.gd")
const BuildingActivityVisualTest = preload("res://tests/test_building_activity_visual.gd")
const BuildingMaintenanceVisualTest = preload("res://tests/test_building_maintenance_visual.gd")
const BuildingProductionYardTest = preload("res://tests/test_building_production_yard.gd")
...
func _run() -> void:
	...
	BuildingMaintenanceVisualTest.new().run(assertions, self)
	BuildingProductionYardTest.new().run(assertions, self)
