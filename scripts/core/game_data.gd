...
const ITEMS := {
	...
	"carrot_seed": {"id": "carrot_seed", "name": "胡萝卜种子", "category": "seed", "sell_price": 0, "buy_price": 6, "base_price": 6, "target_stock": 50, "initial_stock": 45, "daily_liquidity": 20, "volatility": "essential", "max_stack": 99},
	...
	"grain_seed": {"id": "grain_seed", "name": "谷物种子", "category": "seed", "sell_price": 0, "buy_price": 12, "base_price": 12, "target_stock": 60, "initial_stock": 50, "daily_liquidity": 25, "volatility": "essential", "max_stack": 99},
