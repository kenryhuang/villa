...
const BUILDINGS := {
	...
	"waterwheel": {
		...
		"footprint_x": 2, "footprint_z": 2,
		"cost": {"wood": 120, "stone": 80, "iron_ingot": 10},
	...
	"furnace": {
		"id": "furnace", "name": "熔炉",
		"footprint_x": 2, "footprint_z": 2,
		"cost": {"stone": 120, "brick": 40, "iron_ingot": 10},
		"description": "熔炼矿石、钢材和玻璃",
		"effect": "crafting", "effect_value": 0, "station": "furnace",
	},
	"food_workshop": {
		"id": "food_workshop", "name": "食品工坊",
		"footprint_x": 3, "footprint_z": 2,
		"cost": {"wood": 120, "stone": 60, "glass": 10},
	...
	"textile_machine": {
		...
		"footprint_x": 2, "footprint_z": 2,
		"cost": {"wood": 100, "stone": 40, "iron_ingot": 10},
	...
	"quarry": {
		"id": "quarry", "name": "采石场",
		"footprint_x": 3, "footprint_z": 3,
		"cost": {"wood": 120, "stone": 100, "iron_ingot": 10},
	...
	"mine": {
		"id": "mine", "name": "矿场",
		"footprint_x": 3, "footprint_z": 3,
		"cost": {"wood": 200, "stone": 160, "steel": 5},
