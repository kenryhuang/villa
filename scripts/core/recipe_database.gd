...
static var _recipes: Dictionary = {
	...
	"bread": _recipe("bread", "面包", "food_workshop", {"flour": 2, "egg": 1}, {"bread": 2}, 360, 1),
	"honey_cake": _recipe("honey_cake", "蜂蜜蛋糕", "food_workshop", {"flour": 2, "egg": 1, "honey": 1}, {"honey_cake": 1}, 720, 2),
