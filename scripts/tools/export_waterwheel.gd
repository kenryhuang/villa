...
func run() -> void:
	...
	var manifest := {"asset":"waterwheel","version":1,"method":"native_procedural_geometry","engine":Engine.get_version_info().string,
		...
		"parameters":{"units":"metres","up":"Y","core_footprint":[2,2],"wheel_radius":1.14,"axle":"X","water_facing":"+Z","irrigation_radius_cells":4,"construction_groups":["Foundation","Frame","Walls","Roof","Details","Rotor"]},
